  ...
  <div class="relative z-10 container-premium">
    <div class="max-w-4xl mx-auto">
      ...
      <div class="text-center">
        ...
        {{-- Headline --}}
        <h2 class="text-4xl sm:text-5xl md:text-6xl font-display font-bold text-cream mb-4 animate-fade-in">
          ¿Listo para disfrutar?
        </h2>

        {{-- Subheading --}}
        <p class="text-lg sm:text-xl text-gray-100 mb-8 max-w-2xl mx-auto animate-fade-in" style="animation-delay: 0.2s;">
          Contáctanos por WhatsApp y realiza tu pedido en menos de 5 minutos. 
          Entrega rápida a domicilio en Engativá.
        </p>

        {{-- CTA Button --}}
        <div class="animate-fade-in" style="animation-delay: 0.4s;">
          <a 
            href="https://wa.me/573001234567?text=Hola%20Bocaditos%20Criollos%2C%20quiero%20hacer%20mi%20pedido%20ahora"
            target="_blank"
            rel="noopener noreferrer"
            class="inline-flex items-center gap-3 px-8 md:px-12 py-4 md:py-5 rounded-xl bg-white text-burnt-red-600 font-bold text-lg md:text-xl hover:bg-gray-100 hover:shadow-premium-lg transform hover:-translate-y-1 transition-all duration-300"
          >
        ...
        <div class="mt-12 grid grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
          <div class="text-center animate-fade-in" style="animation-delay: 0.6s;">
            ...
            <p class="text-sm text-gray-100">Entrega en 15-20 min</p>
          </div>
          <div class="text-center animate-fade-in" style="animation-delay: 0.7s;">
            <div class="text-3xl mb-2">💳</div>
            <p class="text-sm text-gray-100">Transferencia o efectivo</p>
          </div>
