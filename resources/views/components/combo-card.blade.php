...
>
  ...
  <div class="glass rounded-2xl overflow-hidden h-full flex flex-col transition-all duration-300 hover:border-warm-orange-500/80 hover:bg-warm-orange-500/5 hover:shadow-premium-lg @if($featured) ring-2 ring-warm-orange-500/40 @endif">
    ...
    {{-- Image Container - aspect-square for consistent 1:1 images --}}
    <div class="relative aspect-square overflow-hidden bg-gradient-to-br from-warm-orange-600 to-warm-orange-900">
      ...
      @else
        ...
        <div class="absolute inset-0 flex items-center justify-center">
          <span class="text-6xl sm:text-7xl md:text-8xl opacity-30 select-none">{{ $placeholderEmoji }}</span>
        </div>
      @endif
